...
<head>
    ...
    <title>{% block title %}Stampee{% endblock %}</title>
        ...
        <nav class="pied-page__navigation">
            <div class="pied-page__section pied-page__section--droite">
                ...
                <ul class="pied-page__liste">
                    ...
                    <li><a href="#">Aide : Connexion</a></li>
                    <li><a href="#">Aide : Inscription</a></li>
                    <li><a href="#">Aide : Fiche d'enchère</a></li>
                </ul>
            </div>
            <div class="pied-page__logo">
                <img src="{{ asset('images-optimisees/Logos/logo-2-alt.webp') }}" alt="Logo">
            </div>
