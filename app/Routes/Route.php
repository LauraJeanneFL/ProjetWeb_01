...
class Route{
    ...
    public static function dispatch(){
        ...
        $urlPath = str_replace(rtrim(BASE, '/'), '', rtrim($urlSegments[0], '/'));
        $method = $_SERVER['REQUEST_METHOD'];
        
        //var_dump("URL demandée : " . $_SERVER['REQUEST_URI']);
        //var_dump("URL après nettoyage : " . $urlPath);
        //var_dump("Routes enregistrées :", self::$routes);
